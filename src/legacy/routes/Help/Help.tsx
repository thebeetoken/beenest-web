  ...
  <HelpContainer>
    ...
    <section>
      ...
      <article>
        ...
        <p>
          Creating an in-house Bee Token that interacts with the Beenest platform allows the network to have aligned goals and incentives, prepares a platform to be agnostic to a singular cryptocurrency or digital token, and allows better management of the side chain. <BeeLink href="/legacy" target="_blank">Read more</BeeLink>
        </p>
