  ...
  <HelpContainer>
    ...
    <section>
      ...
      <article>
        ...
        <p>
          Please attempt to resolve the dispute by going to the listing page and clicking "Contact Host". If you are not able to resolve your dispute with the host, please notify Beenest of the dispute by emailing <BeeLink href="mailto:support@beenest.com.com" target="_blank" >support@beenest.com.com</BeeLink>.
        </p>
      ...
      <article>
        ...
        <p>
          No. We only support a single cancellation policy at the moment. If it is important to you to have an alternative cancellation policy, please write to us at <BeeLink href="mailto:support@beenest.com.com" target="_blank" >support@beenest.com.com</BeeLink>.
        </p>
      </article>
      <div className="grey-line"></div>
      <article>
      ...
      <article>
        <div>
          <p>Still need help?</p>
          <BeeLink href="mailto:support@beenest.com.com" target="_blank">
